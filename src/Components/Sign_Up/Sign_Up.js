...
const Sign_Up = () => {
    ...
    const register = async (e) => {
        ...
        if (json.authtoken) {
            ...
            navigate("/");   //on directing to home page you need to give logic to change login and signup buttons with the name of the user and logout button where you have implemented Navbar functionality
        } else {
            if (json.errors) {
